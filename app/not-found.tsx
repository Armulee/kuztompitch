    ...
    return (
        <main className='w-full h-screen flex flex-col items-center justify-center relative overflow-hidden'>
            ...
            <div className='relative text-center'>
                ...
                <Link
                    href={"/"}
                    className='inline-block px-8 py-3 bg-white text-black rounded-full font-medium hover:bg-white/90 hover:shadow-[0_0_25px_rgba(255,255,255,0.25)] transition-all duration-300 hover:scale-105'
                >
                    Back to main page
                </Link>
            </div>
