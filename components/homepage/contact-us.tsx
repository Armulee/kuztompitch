                            ...
                            {contactInfo.map((info, index) => (
                                ...
                                >
                                    <div className='flex items-start gap-4'>
                                        <div className='flex-shrink-0 w-12 h-12 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center text-white group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300'>
                                            {info.icon}
                                        </div>
                                        <div className='flex-1'>
                                            <h3 className='font-bold text-xl md:text-2xl mb-2 text-white group-hover:text-white transition-all duration-300'>
                                                {info.title}
                                            </h3>
